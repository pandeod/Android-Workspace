...
public class Main2Activity extends AppCompatActivity {
    ...
    private static String day1="Monday";
    private static String day2="Tuesday";
    private static String day3="Wednesday";
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mFirebaseDatabase =FirebaseDatabase.getInstance();
             ...
             mRef1=mFirebaseDatabase.getReference().child("menu").child("week1").child(day1);
        ...
        public void display(View rootView)
        {
            ...
            TextView txt=rootView.findViewById(R.id.section_label);
            txt.setText(total);
        }
    }
